...
I'm a **B.Tech Computer Science student at IIT Jodhpur**, deeply interested in building **backend infrastructure**, **agentic AI systems**, and **scalable, production-grade platforms**.

- 🧠 Worked on **Agentic AI**, multi-agent coordination, and LLM-driven systems
- ⚙️ Strong inclination toward **backend engineering, streaming systems, and system design**  
- 🏆 **Inter IIT Tech Meet 14.0 – Gold Medal** (Pathway Problem Statement)  
